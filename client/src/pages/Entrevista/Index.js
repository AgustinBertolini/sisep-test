...
import HangDownModal from "./components/HangDownModal";
library.add(faPhoneSlash);

const Entrevista = () => {
  const {me, callAccepted, callEnded} = useContext(SocketContext);
  ...
  return (
    <>
      ...
      />
      <HangDownModal open={showHangDownModal} setOpen={setShowHangDownModal} />
    </>
  );
};
